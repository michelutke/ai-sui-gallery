...
package com.appswithlove.ai.ui.llmsingleturn
    ...
    viewModelScope.launch(Dispatchers.Default) {
      ...
      val supportImage =
        model.llmSupportImage &&
          task.id == com.appswithlove.ai.data.BuiltInTaskId.LLM_ASK_IMAGE
      val supportAudio =
        model.llmSupportAudio &&
          task.id == com.appswithlove.ai.data.BuiltInTaskId.LLM_ASK_AUDIO
