...
constructor(private val userDataDataStore: DataStore<UserData>) {
   ...
   *
   * Most call sites should prefer using [com.appswithlove.ai.common.SystemPromptHelper
   * .getEffectiveSystemPrompt], which includes the necessary fallback logic. Direct use of this
   * method is rare.
   *
   * @param taskId The ID of the task.
